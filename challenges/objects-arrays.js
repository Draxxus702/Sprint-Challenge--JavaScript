...
function univer(school) {
    school.sort(function(a, b) {
...
function getStudentInfo(graduates, index) {
    contactInfo = graduates[index]
...
function getScienceName(zooAnimals) {
